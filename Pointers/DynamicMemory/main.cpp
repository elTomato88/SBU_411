...
void FillRand(char arr[], const int n, int minRan=0, int minRand=100);
...
void main()
{
	...
	*/
	...
	typedef double DataType; // typedef существующему типу данных дает второе имя
	...
	FillRand(arr[rows - 1], cols, 48, 58);
	Print(arr, rows, cols);
